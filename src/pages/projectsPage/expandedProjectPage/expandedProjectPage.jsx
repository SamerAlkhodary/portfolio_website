...
const ExpandedProjectPage = (props,ref)=> {
	...
	const beforeImages= useCallback(()=>{
		...
		for(let i=1; i<project.beforeImageCount;i++){
			images.push(<Image style={imagesStyle} src={`/assets/images/projects/${project.title}/b-${i}.webp`} key={i} />);
		}
		return images;
	...
	const afterImages= useCallback(()=>{
		...
		for(let i=1; i<=project.afterImageCount;i++){
			images.push(<Image style={imagesStyle} src={`/assets/images/projects/${project.title}/a-${i}.webp`} key={i}  />);
		}
		return images;
	...
	const progressImages=  useCallback(()=>{
		...
		for(let i=1; i<=project.progressImages;i++){
			images.push(<Image style={imagesStyle} src={`/assets/images/projects/${project.title}/p-${i}.webp`} key={i}  />);
		}
		return images;
